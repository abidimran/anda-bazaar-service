...
public class FavoriteMarketController {
    ...
    public ResponseEntity<FavoriteMarket> addFavorite(
        ...
        return ResponseEntity
                ...
                .body(
                        favoriteMarketService.addFavorite(
                                userId,
                                marketId
                        )
                );
    ...
    public ResponseEntity<Void> removeFavorite(
        ...
        favoriteMarketService.removeFavorite(
                userId,
                marketId
        );
    ...
    public ResponseEntity<List<FavoriteMarket>> getUserFavorites(
            @PathVariable Long userId) {
    ...
    public ResponseEntity<Boolean> isFavorite(
        ...
        return ResponseEntity.ok(
                favoriteMarketService.isFavorite(
                        userId,
                        marketId
                )
        );
