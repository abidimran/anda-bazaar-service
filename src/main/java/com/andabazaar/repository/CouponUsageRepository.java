...
public interface CouponUsageRepository
    ...
    List<CouponUsage> findByUserIdOrderByUsedAtDesc(
            Long userId
    );

    List<CouponUsage> findByCouponIdOrderByUsedAtDesc(
            Long couponId
    );

    List<CouponUsage> findByUserIdAndCouponIdOrderByUsedAtDesc(
            Long userId,
            Long couponId
    );
