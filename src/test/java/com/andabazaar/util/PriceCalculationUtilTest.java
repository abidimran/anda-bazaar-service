...
class PriceCalculationUtilTest {
    ...
    class CalculateChangeTests {
        ...
        void returnsPositiveChange() {
            ...
            BigDecimal result =
                    PriceCalculationUtil.calculateChange(
                            previous, current);

            assertEquals(
                    new BigDecimal("2.50"), result);
        }
        ...
        void returnsZeroWhenEqual() {
            ...
            assertEquals(
                    BigDecimal.ZERO.setScale(2), result);
        }
    ...
    class CalculateChangeTypeTests {
        ...
        void returnsIncrease() {
            ...
            String result =
                    PriceCalculationUtil.calculateChangeType(
                            new BigDecimal("5.00"),
                            new BigDecimal("8.00"));
    ...
    class CalculatePercentageChangeTests {
        ...
        void calculatesPercentageIncrease() {
            ...
            BigDecimal result =
                    PriceCalculationUtil.calculatePercentageChange(
                            new BigDecimal("100.00"),
                            new BigDecimal("125.00"));

            assertEquals(
                    new BigDecimal("25.00"), result);
        }
    ...
    class CalculateAverageTests {
        ...
        void calculatesAverage() {
            ...
            BigDecimal result =
                    PriceCalculationUtil.calculateAverage(
                            prices);

            assertEquals(
                    new BigDecimal("20.00"), result);
        }
    ...
    class FindLowestPriceTests {
        ...
        void findsLowest() {
            ...
            BigDecimal result =
                    PriceCalculationUtil.findLowestPrice(
                            prices);

            assertEquals(
                    new BigDecimal("5.00"), result);
        }
    ...
    class FindHighestPriceTests {
        ...
        void findsHighest() {
            ...
            BigDecimal result =
                    PriceCalculationUtil.findHighestPrice(
                            prices);
